...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    // 뷰티 서브카테고리
    'beauty.all': '전체',
    'beauty.skincare': '스킨케어',
    'beauty.maskpack': '마스크팩',
    'beauty.cleansing': '클렌징',
    'beauty.dermo': '더모 코스메틱',
    'beauty.hair': '헤어케어',
    'beauty.body': '바디케어',
    'beauty.suncare': '선케어',
    'beauty.makeup': '메이크업',
    'ranking.button': '이거요!',
    'ranking.viewDetails': '상세보기',
    ...
    'auth.goLogin': '로그인 하러가기',
    'auth.goSignup': '회원가입 하러가기',
    'auth.welcome': 'Vina-K에 오신 것을 환영합니다.',
    'auth.loginSuccess': '로그인 성공!',
    'auth.signupSuccess': '회원가입 완료!',
    'auth.logout': '로그아웃',
    'auth.address.guide': '시/군/구 및 상세주소를 입력해주세요',
  },
  vi: {
    // Header
    'header.title': 'Vina-K',
    ...
    'beauty.all': 'Tất cả',
    'beauty.skincare': 'Chăm sóc da',
    'beauty.maskpack': 'Mặt nạ',
    'beauty.cleansing': 'Tẩy trang/Rửa mặt',
    'beauty.dermo': 'Dược mỹ phẩm',
    'beauty.hair': 'Chăm sóc tóc',
    'beauty.body': 'Chăm sóc cơ thể',
    'beauty.suncare': 'Chống nắng',
    'beauty.makeup': 'Trang điểm',
    'ranking.button': 'Cái này!',
    'ranking.viewDetails': 'Xem chi tiết',
    ...
    'auth.goLogin': 'Đăng nhập ngay',
    'auth.goSignup': 'Đăng ký ngay',
    'auth.welcome': 'Chào mừng đến với Vina-K',
    'auth.loginSuccess': 'Đăng nhập thành công!',
    'auth.signupSuccess': 'Đăng ký thành công!',
    'auth.logout': 'Đăng xuất',
    'auth.address.guide': 'Vui lòng nhập Tỉnh/Thành phố, Quận/Huyện, Phường/Xã',
  },
}
