...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    // Admin
    'admin.back': '목록으로',
    'admin.requestDetail': '요청 상세',
    'admin.requestDate': '요청일',
    'admin.status.pending': '대기중',
    'admin.status.reviewed': '승인완료',
    'admin.status.ordered': '주문완료',
    'admin.paymentInfo': '주문 및 결제 정보',
    'admin.depositPaid': '입금완료 ✅',
    'admin.depositPending': '입금대기 ⏳',
    'admin.paymentHistory': '결제 내역',
    'admin.depositAmount': '청구된 선금 (70%)',
    'admin.totalAmount': '총 주문 금액',
    'admin.depositStatus': '입금 상태',
    'admin.depositConfirm': '입금 확인 처리 (Click)',
    'admin.confirmed': '확인 완료',
    'admin.shippingInfo': '배송지 정보',
    'admin.noShippingInfo': '배송지 정보가 없습니다.',
    'admin.originalLink': '원본 링크 열기',
    'admin.requestQuantity': '요청 수량',
    'admin.adminInput': '관리자 입력',
    'admin.optionPrice': '옵션별 가격 설정 (권장)',
    'admin.optionName': '옵션명 (예: 100ml)',
    'admin.price': '가격',
    'admin.addOption': '+ 옵션 추가',
    'admin.weight': '상품 무게 (배송비 계산용)',
    'admin.weightPlaceholder': '예: 0.5',
    'admin.weightDesc': '* 입력 시 배송비가 자동 계산됩니다. (150,000 VND/kg)',
    'admin.unitPrice': '기본 단가 (옵션 없을 시 적용)',
    'admin.unitPricePlaceholder': '예: 500000',
    'admin.legacyOption': '▼ 구버전 옵션 입력창 열기 (단순 문자열)',
    'admin.capacity': '용량 (구버전)',
    'admin.color': '색상 (구버전)',
    'admin.etc': '기타 (구버전)',
    'admin.userResponse': '📢 사용자 답변',
    'admin.statusSetting': '구매 상태 설정',
    'admin.approve': '✅ 승인 (구매가능)',
    'admin.needsInfo': '❓ 정보 요청',
    'admin.reject': '⛔ 구매 불가',
    'admin.adminNote': '관리자 메모',
    'admin.adminNotePlaceholder': '고객에게 보낼 안내 메시지를 입력하세요',
    'admin.totalProducts': '총',
    'admin.cancel': '취소',
    'admin.tempSave': '임시 저장',
    'admin.confirm': '견적 승인 완료 (Confirm)',
    'admin.saving': '저장 중...',
  },
  vi: {
    // Header
    ...
    // Admin
    'admin.back': 'Quay lại',
    'admin.requestDetail': 'Chi tiết yêu cầu',
    'admin.requestDate': 'Ngày yêu cầu',
    'admin.status.pending': 'Đang chờ',
    'admin.status.reviewed': 'Đã duyệt',
    'admin.status.ordered': 'Đã đặt hàng',
    'admin.paymentInfo': 'Thông tin thanh toán',
    'admin.depositPaid': 'Đã thanh toán ✅',
    'admin.depositPending': 'Chờ thanh toán ⏳',
    'admin.paymentHistory': 'Lịch sử thanh toán',
    'admin.depositAmount': 'Tiền cọc (70%)',
    'admin.totalAmount': 'Tổng tiền',
    'admin.depositStatus': 'Trạng thái tiền cọc',
    'admin.depositConfirm': 'Xác nhận đã nhận tiền (Click)',
    'admin.confirmed': 'Đã xác nhận',
    'admin.shippingInfo': 'Thông tin giao hàng',
    'admin.noShippingInfo': 'Không có thông tin giao hàng.',
    'admin.originalLink': 'Mở link gốc',
    'admin.requestQuantity': 'Số lượng',
    'admin.adminInput': 'Admin nhập liệu',
    'admin.optionPrice': 'Cài đặt giá theo tùy chọn (Khuyên dùng)',
    'admin.optionName': 'Tên (VD: 100ml)',
    'admin.price': 'Giá',
    'admin.addOption': '+ Thêm tùy chọn',
    'admin.weight': 'Cân nặng (Để tính phí ship)',
    'admin.weightPlaceholder': 'VD: 0.5',
    'admin.weightDesc': '* Phí ship sẽ tự động tính khi nhập số liệu (150,000 VND/kg)',
    'admin.unitPrice': 'Đơn giá cơ bản',
    'admin.unitPricePlaceholder': 'VD: 500000',
    'admin.legacyOption': '▼ Mở nhập liệu cũ (Chuỗi đơn giản)',
    'admin.capacity': 'Dung tích',
    'admin.color': 'Màu sắc',
    'admin.etc': 'Khác',
    'admin.userResponse': '📢 Phản hồi từ khách',
    'admin.statusSetting': 'Cài đặt trạng thái',
    'admin.approve': '✅ Duyệt (Mua được)',
    'admin.needsInfo': '❓ Cần thêm thông tin',
    'admin.reject': '⛔ Không mua được',
    'admin.adminNote': 'Ghi chú cho khách',
    'admin.adminNotePlaceholder': 'Nhập tin nhắn hướng dẫn cho khách',
    'admin.totalProducts': 'Tổng',
    'admin.cancel': 'Hủy',
    'admin.tempSave': 'Lưu tạm',
    'admin.confirm': 'Hoàn tất duyệt (Confirm)',
